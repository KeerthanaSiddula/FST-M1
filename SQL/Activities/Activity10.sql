...
SELECT a.customer_name, a.city, b.name, b.commission FROM customers a  INNER JOIN salesman b ON a.salesman_id=b.salesman_id;
...
SELECT customer_name, salesman_name FROM customers  INNER JOIN salesman ON customers.salesman_id=salesman.salesman_id;
...
SELECT customer_id, customer_name, grade,salesman_name FROM customers  LEFT OUTER JOIN salesman ON customers.salesman_id=salesman.salesman_id WHERE grade<300  ORDER BY customer_id;
...
SELECT order_no, order_date, purchase_amount, customer_name, grade, salesman_name, commission FROM orders  INNER JOIN customers ON orders.customer_id=customers.customer_id  INNER JOIN salesman ON orders.salesman_id=salesman.salesman_id;
...
SELECT grade, COUNT(*) AS CUSTOMERSCOUNT FROM customers GROUP BY grade HAVING grade>(SELECT AVG(grade) FROM customers WHERE city='New York');
